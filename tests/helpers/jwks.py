...
from fastapi_security._optional_dependencies import (
...
skipif_oauth2_dependency_not_installed = pytest.mark.skipif(
    not OAUTH2_DEPENDENCY_INSTALLED, reason="`oauth2` extra not installed"
)


if OAUTH2_DEPENDENCY_INSTALLED:
